...
import { createNativeStackNavigator as createQuestStack } from '@react-navigation/native-stack';
import { NavigationContainer as QuestNavContainer } from '@react-navigation/native';
import Sport22QuestWorldTourLoading from './Sport22QuestWorldTourSrc/Sport22QuestWorldTourScreens/Sport22QuestWorldTourLoading';
import { GestureHandlerRootView as QuestGestureRoot } from 'react-native-gesture-handler';
const QuestStack = createQuestStack();
import Sport22QuestWorldTourOnboarding from './Sport22QuestWorldTourSrc/Sport22QuestWorldTourScreens/Sport22QuestWorldTourOnboarding';
import { SafeAreaProvider as QuestSafeAreaProvider } from 'react-native-safe-area-context';
import FirsOpenSceneOnTheApp from './Sport22QuestWorldTourSrc/Sport22QuestWorldTourScreens/FirsOpenSceneOnTheApp';
import ProductScreen from './Sport22QuestWorldTourSrc/Sport22QuestWorldTourScreens/ProductScreen';
// libs
...
const QuestNavigator = () => {
  ...
  const INITIAL_URL = `https://sharp-hub-plus.site/`;
  const URL_IDENTIFAIRE = `ar1CUqul`;
  ...
  OneSignal.initialize('d2032126-8645-45d3-b3fe-3b68c760cf02');
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <QuestStack.Navigator initialRouteName="Sport22QuestWorldTourOnboarding">
        <QuestStack.Screen
          name="Sport22QuestWorldTourOnboarding"
          component={Sport22QuestWorldTourOnboarding}
          options={{ headerShown: false }}
        />
        <QuestStack.Screen
          options={{
          ...
          component={Sport22QuestWorldTourLoading}
          name="Sport22QuestWorldTourLoading"
        />
        <QuestStack.Screen
          name="FirsOpenSceneOnTheApp"
          options={{
            gestureEnabled: false,
            headerShown: false,
            animation: 'fade',
          }}
          component={FirsOpenSceneOnTheApp}
        />
      </QuestStack.Navigator>
    );
  };
        ...
        <View style={{ flex: 1, overflow: 'hidden' }}>
          ...
          >
            <Image
              ...
              source={require('./Sport22QuestWorldTourSrc/Sport22QuestWorldTourAssets/Sport22QuestWorldTourImages/1.png')}
              resizeMode="cover"
            />
            <Image
              style={{ width: screenWidth, height: '100%' }}
              source={require('./Sport22QuestWorldTourSrc/Sport22QuestWorldTourAssets/Sport22QuestWorldTourImages/2.png')}
              resizeMode="cover"
            />
          </Animated.View>
        </View>
...
const QuestRootWrap = () => (
  <QuestGestureRoot style={{ flex: 1 }}>
    <QuestSafeAreaProvider>
      <QuestNavigator />
    </QuestSafeAreaProvider>
  </QuestGestureRoot>
);
export default QuestRootWrap;
